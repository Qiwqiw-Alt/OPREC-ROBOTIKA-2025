...
* SCLK (Serial Clock) → Sinyal clock yang dihasilkan Master untuk sinkronisasi transfer data
* CS/SS (Chip Select / Slave Select) → Digunakan Master untuk memilih perangkat Slave yang ingin diajak berkomunikasi
